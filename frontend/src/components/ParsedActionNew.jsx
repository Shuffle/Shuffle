			...
			{appMayNeedAuth ? (
				<div style={{ marginTop: 15, position: "relative", }}>
					...
					>
						...
						<Tooltip title="Manage authentication" placement="top" arrow>
							<SettingsIcon
								style={{
									marginRight: 10,
									fontSize: 20,
		...
		{/* :) will be changed soon : Find action */}
			<div style={{
				...
				{isAgent ? (
					...
					<Autocomplete
						id="action_search"
						disabled={isAgent || selectedApp?.actions?.length <= 1 || (selectedAction?.parent_controlled === true && workflow?.parentorg_workflow?.length > 0)}
						autoHighlight
			...
			{activeMainTab === "setup" && appMayNeedAuth && !hasAuth && !isAgent && !isIntegration ? (
				<div
					style={{
						marginTop: 16,
						padding: 16,
