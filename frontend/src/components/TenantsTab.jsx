...
const TenantsTab = memo((props) => {
            ...
            fetch(url, {
                ...
                .then((response) =>
                    response.json().then((responseJson) => {
                        if (responseJson["success"] === false) {
                            toast("Failed updating tenant: ", responseJson.reason);
                        } else {
                            toast("Successfully edited tenant!");
                        }
                    }),
                )
                .catch((error) => {
                ...
                .then((data) => {
                    if (data.success) {
                        ...
                        if (data.reason) {
                            ...
                            toast.error("Failed to delete sub-tenant. Please try again or contact support@shuffler.io for help.");
                        }
                    }
                })
                .catch((error) => {
        ...
        return (
            <Modal open={open} >
                <div style={boxStyling}>
                    ...
                    <h1 style={{ textAlign: "center", margin: "0 0 20px 0" }}>Sub-Tenant</h1>
                    ...
                    >
                        <label>If you delete your sub-tenant then:</label>
                        <ul style={{ textAlign: "left" }}>
                            <li>
                                <label>
                                    Your sub-tenant information will be removed from our Database
                                    permanently.
                                </label>
                            </li>
                            <li>
                        ...
                        >
                            <label>Enter password to delete sub-tenant {" " + selectedSuborg?.name}</label>
                            <TextField
                                style={{
    ...
    const modalView = (
        ...
        >
            <DialogTitle>
                <Typography variant='h5' color="textPrimary">Add Sub-Tenant</Typography>
            </DialogTitle>
            <DialogContent>
                <div>
                    Name
    ...
    return (
        <div style={{ width: "100%", minHeight: 1100, boxSizing: 'border-box', padding: "27px 10px 19px 27px", height: "100%", backgroundColor: theme.palette.platformColor, borderTopRightRadius: '8px', borderBottomRightRadius: 8, borderLeft: theme.palette.defaultBorder, }}>
            ...
            <div style={{ height: "100%", overflowY: "auto", overflowX: 'hidden', scrollbarColor: theme.palette.scrollbarColorTransparent, scrollbarWidth: 'thin' }}>
                                    ...
                                    <ListItem style={{ display: "table-row" }}>
                                        {Array(5).fill().map((_, index) => (
                                            <ListItemText
                                                ...
                                                primary={index === 1 ? `Parent Tenant not found or May be you are not part of parent org. Please contact ${supportEmail}` : null}
                        ...
                        <div>
                            ...
                            <div style={{ borderRadius: 4, marginTop: 24, border: theme.palette.defaultBorder, width: "100%" }}>
                                {!suborglistOpen ? (
                                    ...
                                    >
                                        Show Sub-Tenants <ArrowDropDownIcon />
                                    </Button>
                                ) : (
                                    <DataGrid
